...
ActiveRecord::Schema.define(version: 2022_05_07_112803) do
  ...
  create_table "items", force: :cascade do |t|
    ...
    t.integer "common_square"
    t.boolean "second"
    t.string "image_flat"
    t.string "image_floor"
    t.string "image_for_integration"
    t.string "image_3d"
    t.integer "discount_max"
    t.integer "discount_campaign"
